...
extern "C" UINT_PTR NtCreateFileSyscall = NULL;
...
int main() {
	...
	UINT_PTR pNtCreateFileAddress = NULL;
	pNtCreateFileAddress = (UINT_PTR)GetProcAddress(ntdll, "NtCreateFile");
	NtCreateFileSyscall = pNtCreateFileAddress + 0x12; //syscall address

	// filename
	RtlInitUnicodeString(&filename, L"\\??\\C:\\Users\\xd\\Desktop\\indirect_syscall.txt");
